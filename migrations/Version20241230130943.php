 ...
 */
final class Version20241230130943 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE project ADD device_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_2FB3D0EE94A4C7D4');
        $this->addSql('ALTER TABLE project DROP device_id');
    }
}
